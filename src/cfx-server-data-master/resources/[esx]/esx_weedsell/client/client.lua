...
function interact()
	...
	if ped ~= oldped then
		...
		ESX.ShowNotification('You acted sketchy (moved far away) and the buyer was no longer interested.', true, false, 130);
		SetPedAsNoLongerNeeded(oldped)
		selling = false
		return
	end
	...
	if percent <= 3 then
		ESX.ShowNotification('Not interested', false, true, 130)
	elseif percent <= 10 then
		...
		ESX.ShowNotification('The buyer is calling the police!', true, true, 50)
